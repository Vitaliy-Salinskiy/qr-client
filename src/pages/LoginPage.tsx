        ...
        <div className="min-h-screen flex flex-col justify-center items-center py-16 gap-10 text-white font-bold">
          <div className="bg-white p-4 flex flex-col gap-3 rounded-lg w-[320px]">
            ...
            >
              <div>
                <input
                  className="w-full border-b-2 border-gray-400 text-black rounded-sm outline-none px-[5px] py-[2px] font-normal"
                  placeholder="user name"
                  type="text"
                  {...register("username")}
                />
                {errors.username?.message && (
                  <p className="text-mainOrange font-medium text-[14px] ml-1">
                    {errors.username?.message}
                  </p>
                )}
              </div>
